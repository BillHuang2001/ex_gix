defmodule ExGix.Native do
  ...
  def local_branches(_resource), do: :erlang.nif_error(:nif_not_loaded)
  def remote_branches(_resource), do: :erlang.nif_error(:nif_not_loaded)
  def list_references(_resource, _prefix), do: :erlang.nif_error(:nif_not_loaded)
